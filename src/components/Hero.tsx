...
const Hero = () => {
  return (
    <section className="relative py-6 sm:py-8 md:py-12 min-h-[100vh] lg:min-h-0 flex items-center overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="lg:hidden flex flex-col justify-center h-screen py-2 space-y-2">
              ...
              <div className="relative flex-shrink-0 flex items-center justify-center">
                <div className="relative z-10">
                  <img 
                    ...
                    className="w-full max-w-[280px] sm:max-w-[320px] md:max-w-[360px] mx-auto rounded-xl sm:rounded-2xl shadow-hero"
                  />
                </div>
              ...
              <div className="text-center space-y-3 px-4 flex-shrink-0">
                <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground leading-[1.1] tracking-tight">
                ...
                <div className="pt-3">
                  <Button 
                    variant="default" 
                    size="lg" 
                    className="group px-6 sm:px-8 py-3 text-sm sm:text-base font-semibold shadow-glow hover:shadow-elegant transition-all duration-300"
